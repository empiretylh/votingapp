...
const Home = () => {
  ...
  return (
    <ScrollView style={{flex: 1, padding: 10, backgroundColor: '#f0f0f0'}}>
      <Text style={{fontFamily: 'Roboto-Bold', color: 'black', fontSize: 25}}>
        Developer Info
      </Text>
      <View
        style={{
      ...
      <View>
        ...
        <View style={{flex: 1, marginTop: 10}}>
          <Text
            style={{fontFamily: 'Roboto-Black', color: 'black', fontSize: 20
          }}>
            App Info
          </Text>
          <View
      ...
      <View style={{padding: 10,flex:1,alignItems: 'center' }}>
        <Text style={{color:'black'}}>Copyright 2023 | Apache License</Text>
      </View>
    </ScrollView>
  );
};
